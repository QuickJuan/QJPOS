...
const relativeRoute = (name, params = undefined) => route(name, params, false);

const enableTwoFactorAuthentication = () => {
    enabling.value = true;

    router.post(
        relativeRoute("two-factor.enable"),
        {},
        {
            preserveScroll: true,
            onSuccess: () =>
...
const showQrCode = () => {
    return axios.get(relativeRoute("two-factor.qr-code")).then((response) => {
...
const showSetupKey = () => {
    return axios
        .get(relativeRoute("two-factor.secret-key"))
        .then((response) => {
...
const showRecoveryCodes = () => {
    return axios
        .get(relativeRoute("two-factor.recovery-codes"))
        .then((response) => {
...
const confirmTwoFactorAuthentication = () => {
    confirmationForm.post(relativeRoute("two-factor.confirm"), {
...
const regenerateRecoveryCodes = () => {
    axios
        .post(relativeRoute("two-factor.recovery-codes"))
...
const disableTwoFactorAuthentication = () => {
    ...
    router.delete(relativeRoute("two-factor.disable"), {
        preserveScroll: true,
        onSuccess: () => {
