...
<head>
    ...
    <title>Sales by Date Report – {{ $companyName }}</title>
    <style>
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .btn-print{display:inline-flex;align-items:center;gap:8px;padding:8px 18px;background:#0891b2;color:#fff;border:none;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer}
        ...
        .report-title{font-size:24px;font-weight:800;color:#0891b2;display:flex;align-items:center;gap:10px}
...
<div class="page-wrapper">
    <div class="toolbar no-print">
        <div class="toolbar-meta"><strong>Sales by Date Report</strong> &mdash; {{ $generatedAt }}</div>
    ...
    @else
        <div class="summary-grid">
            <div class="summary-card card-cyan">
                ...
                <div class="sub">records in range</div>
            </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="r num" style="font-weight:600;color:#0891b2">{{ number_format($item->sold) }}</td>
