...
<head>
    ...
    <title>Sales by Cashier/Server Report – {{ $companyName }}</title>
    <style>
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .btn-print{display:inline-flex;align-items:center;gap:8px;padding:8px 18px;background:#7c3aed;color:#fff;border:none;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer}
        ...
        .report-title{font-size:24px;font-weight:800;color:#7c3aed;display:flex;align-items:center;gap:10px}
        ...
        thead tr{background:#f5f3ff;border-bottom:2px solid #ddd6fe}
        thead th{padding:11px 14px;text-align:left;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.05em;color:#5b21b6;white-space:nowrap}
        ...
        tfoot td{padding:12px 14px;font-size:12px;font-weight:700;background:#f5f3ff;border-top:2px solid #ddd6fe;color:#374151}
...
<div class="page-wrapper">
    <div class="toolbar no-print">
        <div class="toolbar-meta"><strong>Sales by Cashier/Server Report</strong> &mdash; {{ $generatedAt }}</div>
    ...
    <div class="report-header">
        ...
        <div class="report-title">
            ...
            Sales by Cashier/Server Report
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="color:#374151">{{ $item->server_name ?? '–' }}</td>
                        <td style="font-weight:500;color:#374151">{{ $item->cashier_name ?? '–' }}</td>
                        <td class="r num">₱{{ number_format($item->gross, 2) }}</td>
                        <td class="r num" style="color:#d97706">₱{{ number_format($item->discount_amount, 2) }}</td>
                        <td class="r num" style="font-weight:700;color:#7c3aed">₱{{ number_format($item->sub_total, 2) }}</td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
