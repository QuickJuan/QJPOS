...
use App\Mail\OrdersReport\DailySalesReportPerInvoiceMail;

class DailySalesReportPerInvoiceJob implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(): void
    {
        ...
        $mail->send(new DailySalesReportPerInvoiceMail($this->filePath));
    }
}
